...
class Testy(unittest.TestCase):
    ...
    def test_kupno_po_odliczonej_kwocie(self):
    ...
    def test_kupno_po_wiekszej_kwocie(self):
        self.automat.wrzuc(3)
        self.automat.wrzuc(0.5)
        self.automat.wrzuc(0.5)
        msg, status, reszta = self.automat.zamowienie(15)
    ...
    def test_kupno_do_wyczerpania_zapasow(self):
        for i in range(5):
            self.automat.wrzuc(3)
            self.automat.wrzuc(0.5)
    ...
    def test_wplacanie_po_groszu(self):
